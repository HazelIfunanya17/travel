    ...
    >
      <div className="lg:w-[1200px] mx-auto flex justify-between items-center h-full w-full">
        ...
        <div className="flex font text-base text-white items-center gap-14">
          {links.map((link) => (
            <p
              className="text-sm font-semibold hover:font-semibold select-none cursor-pointer relative after:hover:w-1/2 after:duration-500 after:w-0 after:absolute after:h-[2px] after:left-0  after:top-full after:bg-[#ffda2e]
        ...
        <div className="flex gap-7 items-center">
          <p className="text-sm text-[#ffda2e]">Sign up</p>
          <p className="px-5 py-2 cursor-pointer shadow-md rounded-full text-black text-sm font-semibold bg-[#ffda2e]">
            Login
          </p>
        </div>
      </div>
